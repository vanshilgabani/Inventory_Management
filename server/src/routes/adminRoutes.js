...
const { getCustomers, updateSidebarPermissions, updateBuyerSyncPreference, getCustomerDetails, getPaymentRequests, generateCustomerInvoice } = require('../controllers/adminController');
...
router.post('/customers/:customerId/generate-invoice', protect, generateCustomerInvoice);
